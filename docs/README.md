...
**Current phase:** Backend feature development is paused after Sprint 2.29 implementation, whose final disposable/live revalidation remains pending. The PostgreSQL 16.13 [Foundation Baseline](./reviews/FOUNDATION-BASELINE.md) is unchanged. Sprint 3.1 and Sprint 3.2W established the shared Android/Web Flutter foundation, Sprint 3.4 through Sprint 3.6 established the isolated tutorial-speech evaluation path, Sprint 3.7 completed the responsive Reading Player shell, and Sprint 3.8 added local bundled tutorial MP3 playback. Multilingual provider approval, Sepedi narration, real timing/alignment, Flutter/backend audio integration, authentication, offline persistence/synchronization, governed hierarchy, APIs, seeds, additional migrations, and public deployment remain unimplemented or blocked.

## Start here

- [Prolific Platform Master Roadmap](./14-roadmap/master-roadmap.md) - official milestone and sprint sequence.
- [Flutter UI Foundation Review](./reviews/FLUTTER-UI-FOUNDATION-REVIEW.md) - Sprint 3.1 learner entry screens, Material 3 design system, routes, local preview data, accessibility, tests, and integration boundary.
- [Flutter Web Foundation Review](./reviews/FLUTTER-WEB-FOUNDATION-REVIEW.md) - Sprint 3.2W shared Android/Web shell, responsive breakpoints, desktop navigation, setup previews, browser behavior, builds, and deployment boundary.
- [Flutter Reading Player Shell Review](./reviews/FLUTTER-READING-PLAYER-SHELL-REVIEW.md) - Sprint 3.7 responsive presentation shell, local token demonstration, accessibility, tests, and blocked integration boundaries.
- [Local Tutorial Audio Playback Review](./reviews/LOCAL-TUTORIAL-AUDIO-PLAYBACK-FOUNDATION.md) - Sprint 3.8 bundled MP3 playback, audio service boundary, tests, and remaining production limits.
- [Tutorial Audio Generation Foundation](./reviews/TUTORIAL-AUDIO-GENERATION-FOUNDATION.md) - Sprint 3.4 standalone Python 3.12/gTTS generator, language mapping, deterministic output, safety boundaries, tests, and deferred integration.
- [TTS Capability Evaluation](./reviews/TTS-CAPABILITY-EVALUATION.md) - Sprint 3.5 English proof evidence, provider comparison, capability model, decision matrix, listening checklist, and remaining multilingual/alignment blockers.
- [ADR-018: Tutorial Speech Provider Strategy](./decisions/ADR-018-tutorial-speech-provider-strategy.md) - proposed provider-neutral strategy; Azure adapter complete, live evidence and human approval pending.
- [Azure TTS Proof and Multilingual Voice Evaluation](./reviews/AZURE-TTS-PROOF-AND-MULTILINGUAL-EVALUATION.md) - Sprint 3.6 implementation evidence, blocked live proofs, and multilingual decision gates.
